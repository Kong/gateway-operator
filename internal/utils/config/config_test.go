...
func TestFillDataPlaneProxyContainerEnvs(t *testing.T) {
	...
	t.Run("nil doesn't panic", func(t *testing.T) {
		FillContainerEnvs(nil, nil, consts.DataPlaneProxyContainerName, KongDefaults)
	})
	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			FillContainerEnvs(tc.existing, tc.podTemplateSpec, consts.DataPlaneProxyContainerName, KongDefaults)
