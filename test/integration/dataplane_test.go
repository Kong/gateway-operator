...
import (
	...
	"github.com/kong/gateway-operator/api/operator/v1alpha1"
...
func TestDataplaneEssentials(t *testing.T) {
	...
	dataplane, err := operatorClient.OperatorV1alpha1().DataPlanes(namespace.Name).Create(ctx, dataplane, metav1.CreateOptions{})
