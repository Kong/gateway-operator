...
func controlPlanePredicate(
	...
	controlplaneClient := operatorClient.OperatorV1alpha1().ControlPlanes(controlplaneName.Namespace)
	return func() bool {
...
func dataPlanePredicate(
	...
	dataPlaneClient := operatorClient.OperatorV1alpha1().DataPlanes(dataplaneName.Namespace)
	return func() bool {
