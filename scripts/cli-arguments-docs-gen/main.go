...
// This program generates markdown documentation for the KGO executable's flags.
// It skips deprecated and hidden flags.
func main() {
	cfg := cli.New(metadata.Metadata())
	flags := cfg.FlagSet()

	markdown := strings.Builder{}
	markdown.WriteString("<!-- This document is generated by KGO's 'generate.docs' make target, DO NOT EDIT -->\n\n")
...
func getTypeForHuman(flag *pflag.Flag) string {
	...
	case "bool", "string", "duration", "namespaced-name":
		return typ
	default:
		return "string"
	}
