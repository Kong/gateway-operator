...
// GatewayTargetReference is an indicator of the target (Gateway or
// GatewayClass) object that a GatewayConfiguration is meant to attach
// to and provide configuration for. GatewayTargetReference is only
// allowed within the same namespace as the referent.
type GatewayTargetReference struct {
	// Name is the name of the target Gateway or GatewayClass to attach the
	// GatewayConfiguration to.
	Name string `json:"name"`

	// Kind is the object kind to attach the GatewayConfiguration to,
	// either "gateway" or "gatewayclass".
	//
	// +kubebuilder:default=Gateway
	// +optional
	Kind GatewayConfigurationTargetKind `json:"kind,omitempty"`
}
