...
func konnectConfigurationDataPlaneGroupToAPIRequest(
	...
	return sdkkonnectcomp.CreateConfigurationDataPlaneGroup{
		...
		CloudGatewayNetworkID: func() string {
			...
			case konnectv1alpha1.ControlPlaneRefKonnectID:
		...
		Autoscale: func() sdkkonnectcomp.ConfigurationDataPlaneGroupAutoscale {
			...
			case sdkkonnectcomp.ConfigurationDataPlaneGroupAutoscaleTypeConfigurationDataPlaneGroupAutoscaleAutopilot:
				return sdkkonnectcomp.ConfigurationDataPlaneGroupAutoscale{
					...
					ConfigurationDataPlaneGroupAutoscaleAutopilot: &sdkkonnectcomp.ConfigurationDataPlaneGroupAutoscaleAutopilot{
						...
						BaseRps: spec.Autoscale.ConfigurationDataPlaneGroupAutoscaleAutopilot.BaseRps,
						MaxRps:  spec.Autoscale.ConfigurationDataPlaneGroupAutoscaleAutopilot.MaxRps,
					},
				}
			case sdkkonnectcomp.ConfigurationDataPlaneGroupAutoscaleTypeConfigurationDataPlaneGroupAutoscaleStatic:
				return sdkkonnectcomp.ConfigurationDataPlaneGroupAutoscale{
					...
					ConfigurationDataPlaneGroupAutoscaleStatic: &sdkkonnectcomp.ConfigurationDataPlaneGroupAutoscaleStatic{
						...
						InstanceType:       spec.Autoscale.ConfigurationDataPlaneGroupAutoscaleStatic.InstanceType,
						RequestedInstances: spec.Autoscale.ConfigurationDataPlaneGroupAutoscaleStatic.RequestedInstances,
					},
				}
			default:
...
func dataPlaneGroupsResponseToStatus(
	...
	for _, g := range r {
		ret = append(
			...
			konnectv1alpha1.KonnectCloudGatewayDataPlaneGroupConfigurationStatusGroup{
				ID:                    lo.ToPtr(g.ID),
				State:                 lo.ToPtr(string(g.State)),
				CloudGatewayNetworkID: lo.ToPtr(g.CloudGatewayNetworkID),
