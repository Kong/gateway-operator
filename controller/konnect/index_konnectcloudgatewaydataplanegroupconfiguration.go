	...
	return []ReconciliationIndexOption{
		{
			...
			IndexField:   IndexFieldKonnectCloudGatewayDataPlaneGroupConfigurationOnAPIAuthConfiguration,
			ExtractValue: konnectCloudGatewayDataPlaneGroupConfigurationAPIAuthConfigurationRef,
		},
		{
			IndexObject:  &konnectv1alpha1.KonnectCloudGatewayDataPlaneGroupConfiguration{},
...
func konnectCloudGatewayDataPlaneGroupConfigurationAPIAuthConfigurationRef(object client.Object) []string {
	obj, ok := object.(*konnectv1alpha1.KonnectCloudGatewayDataPlaneGroupConfiguration)
	if !ok {
		return nil
	}

	return []string{obj.Spec.KonnectConfiguration.APIAuthConfigurationRef.Name}
}
