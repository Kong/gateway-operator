...
// proxyPorts checks if KONG_PROXY_LISTEN and/or KONG_ADMIN_LISTEN are set in
// DataPlaneDeploymentOptions and based on them returns the proxy and proxySSL
// ports, in case of missing defaults are returned.
//
