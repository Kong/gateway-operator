...
func (d *dummyConverter) ListExistingObjects(ctx context.Context, owner client.Object) ([]unstructured.Unstructured, error) {
	if d.service == nil {
		return nil, nil
	}
...
func (d *dummyConverter) setMetadata(kongService *configurationv1alpha1.KongService) {
	...
	controllerutil.SetOwnerReference(d.service, kongService, d.Scheme(), controllerutil.WithBlockOwnerDeletion(true))
}
