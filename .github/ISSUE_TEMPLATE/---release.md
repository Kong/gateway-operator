...
- [ ] Update the official documentation at [github.com/Kong/docs.konghq.com][docs_repo]
  - [ ] Copy `docs/api-reference.md` to `app/_src/gateway-operator/reference/custom-resources/1.2.x.md`.

    Example:
    ```
    cp ${GATEWAY_OPERATOR_REPO}/docs/api-reference.md ~/docs.konghq.com/app/_src/gateway-operator/reference/custom-resources/1.2.x.md
    ```
