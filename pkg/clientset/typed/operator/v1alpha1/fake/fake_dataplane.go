...
var dataplanesResource = schema.GroupVersionResource{Group: "operator", Version: "v1alpha1", Resource: "dataplanes"}

var dataplanesKind = schema.GroupVersionKind{Group: "operator", Version: "v1alpha1", Kind: "DataPlane"}
