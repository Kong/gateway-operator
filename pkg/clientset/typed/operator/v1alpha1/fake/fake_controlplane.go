...
var controlplanesResource = schema.GroupVersionResource{Group: "operator", Version: "v1alpha1", Resource: "controlplanes"}

var controlplanesKind = schema.GroupVersionKind{Group: "operator", Version: "v1alpha1", Kind: "ControlPlane"}
