...
replace oras.land/oras-go/v2 => github.com/programmer04/oras-go/v2 v2.5.1-0.20241218150055-30e49616b702
...
require (
	...
	github.com/kong/kubernetes-configuration v1.0.0
...
require (
	...
	github.com/kong/go-kong v0.61.0 // indirect
